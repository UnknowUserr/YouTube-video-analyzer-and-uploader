...
print(Fore.LIGHTCYAN_EX + "\nDurée de la vidéo :", yt.length, "secondes")
print(Fore.LIGHTCYAN_EX + "\nDescription :", yt.description)

download = Write.Input("\nVoulez vous télécharger la vidéo ? (y/n) ", Colors.green, interval=0.002, input_color=Colors.white)
    ...
    if download == 'y':
        try:
            while True:
                ...
                Write.Print("\nTéléchargement", Colors.green, interval=0.002)
                Write.Print("...", Colors.green, interval=0.0009)
                dl.download()
                Write.Print("\nTéléchargement terminé !", Colors.green, interval=0.005)
                break
        except ValueError:
